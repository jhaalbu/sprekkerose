...
def trigger():
    ...
    st.markdown('Diagrammene kan også forstørres ved å holde over de og deretter trykke på utvid-knappen opp til høyre for diagrammet.')
    ...
    with st.container():
        ...
        with koll1:
            ...
            axsp.bar(np.deg2rad(np.arange(0, 360, 10)), two_halves, width=np.deg2rad(10), bottom=0.0, color='.8', edgecolor='k')
...
def main():
        ...
        with kol1:
            ...
            st.markdown(
                ...
                **OBS:** Pass på at du skriver inn rett antall målinger, tabellen må fylles inn på nytt om antall målinger endres.
                ...
                ''')
        with kol4:
            av_logo = Image.open(r'C:\Users\niklas.brede\PycharmProjects\Asplan_Viak\forank\av-logo.png')
    ...
    with st.container():
        ...
        st.write('')
        global antall
        antall = st.number_input('Hvor mange målinger av strøk/fall har du?', min_value=1,max_value=100,value=1,step=1)
